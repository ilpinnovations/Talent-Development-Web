...
<?php endif ?>
      ...
      <section id="main-content">
		...
		<h2><i class="fa fa-angle-right"></i> Export Feedback List</h2>
        <div class="row mt">
          		<div class="col-lg-12">
...
echo "<table class='table table-striped table-advance table-hover'>
	                  	  	  <h4><i class='fa fa-angle-right'></i> All Completed Sessions</h4>
	                  	  	  <hr>
                              <thead>
                              <tr>
                                 ...
                                 <!--- <th><i class=' fa fa-edit'></i> Edit Session</th>
                                  ...
                                  <th><i class=' fa fa-download'></i> Download Feedback</th>
                              <th></th>
                              </tr>
                              </thead>";
...
$result6 = mysql_query("SELECT * FROM session WHERE status='1'", $talent_uk);

while($row5 = mysql_fetch_array($result6)) {
	$session_id=$row5['session_id'];
	$result7 = mysql_query("SELECT * FROM session_registration WHERE is_feedback='1' AND session_id='$session_id'", $talent_uk);
