...
<html lang="en">
  <head>
    ...
    <script src="assets/js/chart-master/Chart.js"></script>
     ...
     <script>
	  function delete_session(str)
   { 
   var result=confirm("Do you really want to delete this session?");
if(result)
{
...
xmlhttp.open("GET","delete_session.php?id="+str,true);
xmlhttp.send();
}
 }
	 function message()
   { 
alert('This session cannot be deleted, There are registrations for this session.');
 }
	 function get_list(str)
   { 
   var result=confirm("Do you really wan to delete?");
if(result)
{
   alert(str);
 if (window.XMLHttpRequest)
...
<?php endif ?>
      ...
      <section id="main-content">
		...
		<h2><i class="fa fa-angle-right"></i> Sessions</h2>
        <div  id="delete_ses">
        <div class="row mt">
          		<div class="col-lg-12">
...
echo "<table class='table table-striped table-advance table-hover'>
                              ...
                              <tr>
                                  ...
                                  <th><i class=' fa fa-clock-o'></i> End Time</th>
								   <th><i class='fa fa-bullhorn'></i> Session Category</th>
								    <th><i class='fa fa-bullhorn'></i> Session Description</th> 
									<th><i class='fa fa-bullhorn'></i> Vennue</th>
									   <th><i class='fa fa-bullhorn'></i> Faculty</th>
									    <th><i class='fa fa-bullhorn'></i> Expected Outcome</th>
										 <th><i class='fa fa-bullhorn'></i> Mode of Delivery</th>
		...
		$march_flag++;
                              ...
                              <tr>
                                  ...
                                  <td>" . $row5['start_time'] . "</td>
								   <td>" . $row5['end_time'] . "</td>
                                  <td>" . $row5['session_category'] . "</td>
								  <td>" . $row5['session_description'] . "</td>
								  <td>" . $row5['session_venue'] . "</td>
								  <td>" . $row5['session_faculty'] . "</td>
								  <td>" . $row5['expected_outcome'] . "</td>
								  <td>" . $row5['mode_of_delivery'] . "</td>
