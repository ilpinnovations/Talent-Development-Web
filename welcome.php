...
<?php endif ?>
      ...
      <?php if($role=="Admin"): ?>
      <?php
	  include('content/admin_welcome/admin_welcome_content.php');
	  ?>
<?php elseif($role=="Learning Ambassador"): ?>
<?php
include('content/admin_welcome/ambassador_welcome_content.php');
?>
<?php elseif($role=="hr"): ?>
<?php
include('content/admin_welcome/hr_welcome_content.php');
?>
<?php elseif($role=="rmg"): ?>
<?php
include('content/admin_welcome/rmg_welcome_content.php');
?>
<?php elseif($role=="supervisor"): ?>
<?php
include('content/admin_welcome/supervisor_welcome_content.php');
?>
<?php elseif($role=="Learning Officer"): ?>
<?php
include('content/admin_welcome/officer_welcome_content.php');
?>
<?php elseif($role=="engagement"): ?>
<?php
//include('content/admin_welcome/engagement_welcome_content.php');
...
$result6 = mysql_query("SELECT iou,emp_id,emp_name,emp_email,location FROM users WHERE is_appdownloaded='1'", $talent_uk);
...
$result6 = mysql_query("SELECT iou,emp_id,emp_name,emp_email,location FROM users WHERE is_appdownloaded='0' LIMIT 50", $talent_uk);
