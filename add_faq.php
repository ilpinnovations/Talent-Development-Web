...
if(isset($_POST["submit"]))
{
	...
	$sql = mysql_query("INSERT INTO faq (faq_id,question,answer) VALUES ('','$question','$answer')", $talent_uk);
  ...
  <head>
    ...
    <script src="assets/js/chart-master/Chart.js"></script>
     <script src="assets/js/pace.js"></script>
      <script>
	 function delete_faq(str)
   { 
   var result=confirm("Do you really want to delete this FAQ?");
if(result)
{
...
xmlhttp.open("GET","delete_faq.php?id="+str,true);
xmlhttp.send();
}
 }
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
           <h2><i class="fa fa-angle-right"></i> FAQ</h2>
          	<div class="row mt">
          		<div class="col-lg-12">
...
echo "</table>
  ...
  ?>
            ...
            <h2><i class="fa fa-angle-right"></i> Add FAQ</h2>
          	<div class="row mt">
          		<div class="col-lg-12">
                  <div class="form-panel">
                  <h4 class="mb"><i class="fa fa-angle-right"></i> Add FAQ</h4>
                      <form action="" class="form-horizontal style-form" method="POST" name="addsession" id="addsession">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-7">
                        <input type="text" class="form-control round-form" id="question" name="question" required>
                              </div>
                              </div>
                              <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Answer</label>
                              <div class="col-sm-7">
                            <input type="text" class="form-control round-form" id="answer" name="answer" required> 
                              </div>
                              </div>
                             
                             
                              <div class="form-group">
                          <button type="submit" id="submit" name="submit" class="btn btn-primary btn-lg btn-block">Add Faq</button>
                          </div>
