...
$query = "SELECT * FROM session WHERE status='0' ORDER BY start_date ASC";
...
//$date1= date("m");
//$date2= date("m",strtotime($session_date));

//$date3 = strtotime("+1 months", strtotime($date2)); // returns timestamp
//$date3 =date('m',$date3); 
