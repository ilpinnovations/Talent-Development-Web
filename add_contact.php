...
if(isset($_POST["submit"]))
{
	...
	$contact_contact = $_POST['contact'];
	$contact_role = $_POST['role'];
	
	$sql1 = mysql_query("SELECT * FROM contacts WHERE contact_email='$contact_email'", $talent_uk);
	...
	{
	$sql = mysql_query("INSERT INTO contacts (contact_id,contact_name,contact_email, contact_number,role) VALUES ('','$contact_name','$contact_email','$contact_contact','$contact_role')", $talent_uk);
...
<html lang="en">
  <head>
   ...
   { 
   var result=confirm("Do you really want to delete this contact?");
if(result)
{
...
xmlhttp.open("GET","delete_contact.php?id="+str,true);
xmlhttp.send();
}
 }
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
           <h2><i class="fa fa-angle-right"></i> Contacts</h2>
          	<div class="row mt">
          		<div class="col-lg-12">
...
echo "</table>
  ...
  ?>
            ...
            <h2><i class="fa fa-angle-right"></i> Add Contacts</h2>
          	<div class="row mt">
          		<div class="col-lg-12">
                  <div class="form-panel">
                  <h4 class="mb"><i class="fa fa-angle-right"></i> Add Contacts</h4>
                      <form action="" class="form-horizontal style-form" method="POST" name="addsession" id="addsession">
                          
                          
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Name</label>
                              <div class="col-sm-7">
                        <input type="text" class="form-control round-form" id="name" name="name" required>
                              </div>
                              </div>
                              <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Email</label>
                              <div class="col-sm-7">
                            <input type="email" class="form-control round-form" id="email" name="email" required> 
                              </div>
                              </div>
                              <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Contact</label>
                              <div class="col-sm-7">
                            <input type="number" class="form-control round-form" id="contact" name="contact" required> 
                              </div>
                              </div>
                              <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Role</label>
                              <div class="col-sm-7">
                            <input type="text" class="form-control round-form" id="role" name="role" required>
                              </div>
                              </div>
                              <div class="form-group">
                          <button type="submit" id="submit" name="submit" class="btn btn-primary btn-lg btn-block">Add Contact</button>
                          </div>
